  ...
  return (
    <div className="group relative">
      <Refractor
        ...
        className="max-h-[500px] md:max-h-[600px] overflow-auto"
      />

      <button
        className="absolute right-2 top-2 hidden rounded-sm bg-[#414338] px-2 py-1.5 text-[#f7f8f2] text-white duration-300 focus:outline-none group-hover:block"
        aria-label="copy"
